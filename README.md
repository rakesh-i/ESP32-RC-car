...
3. Once connection is made you can drive the car using AWSD keys on keyboard.
4. You can change speed by changing the motorSpeed() function in server.py
5. If direction is reversed, flip the sign of motorSpeed() values.
